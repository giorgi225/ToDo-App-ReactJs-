...
const CreatePopup = (props)=> {
    ...
    return (
        <div className="absolute top-0 left-0 w-full h-full bg-white">
            <div onClick={()=> props.closeCreatePopup()} className="absolute right-2 top-2 opacity-80 flex items-center cursor-pointer group">
            ...
            <form onSubmit={(e)=> props.submitCreateTask(e, titleInput, textInput)} className="w-full flex flex-col gap-4 max-w-[60%]" method="POST" action="#">
