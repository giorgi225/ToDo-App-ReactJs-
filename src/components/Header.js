    ...
    return (
        ...
        <div className="flex flex-col items-start">
            ...
            <p className="text-black font-medium text-sm">
                {props.todoLength > 0 ?  props.todoLength + " Tasks" : "No Tasks"}
            </p>
        </div>
        <div onClick={()=> props.openCreatePopup()} className="flex items-center justify-center bg-main rounded-full p-2 cursor-pointer opacity-80 hover:opacity-100 transition-all">
